...
(def-with-docs directions "Using Java KeyEvent Class. VK indicates virtual key codes.  https://docs.oracle.com/javase/7/docs/api/java/awt/event/KeyEvent.html for more info"
